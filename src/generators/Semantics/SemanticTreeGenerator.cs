...
public sealed class SemanticTreeGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateType(SourceProductionContext context, string name, SemanticTreeType type)
    {
        ...
        writer.WriteLine();
        writer.WriteLine("using Vezel.Ton.Semantics.Binding;");
        writer.WriteLine("using Vezel.Ton.Semantics.Tree;");
        writer.WriteLine("using Vezel.Ton.Syntax.Tree;");
        writer.WriteLine();
        writer.WriteLine("namespace Vezel.Ton.Semantics.Tree");
        writer.WriteLine("{");
        ...
        {
            writer.WriteLine();
            writer.WriteLine("namespace Vezel.Ton.Semantics");
            writer.WriteLine("{");
